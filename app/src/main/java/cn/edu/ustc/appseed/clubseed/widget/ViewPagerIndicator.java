package cn.edu.ustc.appseed.clubseed.widget;
...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 标题未选中时的颜色
     */
    private final int COLOR_TEXT_NORMAL = getResources().getColor(R.color.white);
    /**
     * 标题选中时的颜色
     */
    private final int COLOR_TEXT_HIGHLIGHTCOLOR = getResources().getColor(R.color.white);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        // 初始时的偏移量
        mInitTranslationX = getScreenWidth() / mTabVisibleCount / 2 - mTriangleWidth
                / 2;
    }
